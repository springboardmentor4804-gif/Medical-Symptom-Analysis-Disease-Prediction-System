@echo off
REM ===========================================================================
REM  MedAssist AI - installer (Fixed for SSL issues)
REM
...
REM
REM  Usage:  double-click, or from a terminal:  install_fixed.bat
REM ===========================================================================
...
echo.
echo ==========================================================
echo   MedAssist AI - installer (SSL Fix)
echo ==========================================================
echo.
...
REM ---------------------------------------------------------------------------
REM 3. Backend dependencies (with SSL fix)
REM ---------------------------------------------------------------------------
echo.
echo [3/6] Installing backend dependencies (this takes a few minutes)...
echo   Note: Using --trusted-host to bypass SSL certificate issues
"%PY%" -m pip install --upgrade pip --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --quiet
"%PY%" -m pip install -r backend\requirements.txt --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --quiet
if errorlevel 1 (
