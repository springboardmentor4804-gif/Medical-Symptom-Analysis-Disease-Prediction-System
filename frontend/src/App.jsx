...
export default function App() {
  ...
  const downloadReport = () => {
    ...
    const disclaimerBanner = `======================================================================\n⚠️ OFFICIAL CLINICAL ADVISORY & MEDICAL DISCLAIMER:\nThis document contains automated statistical predictions generated by an AI machine\nlearning model. This report is NOT a formal medical diagnosis, official lab result,\nor physician's opinion. AI predictions must never replace clinical judgment.\nALWAYS CONSULT A LICENSED PHYSICIAN OR QUALIFIED HEALTHCARE PROVIDER FOR ACCURATE\nDIAGNOSIS AND TREATMENT. In case of emergency, contact local emergency services immediately.\n======================================================================\n\n`;
    const content = `${disclaimerBanner}MEDASSIST AI - CLINICAL REPORT\n------------------------------------------\nPatient Email: ${userEmail}\nPredicted Disease: ${aiResult.predicted_disease}\nAI Confidence Score: ${aiResult.confidence_score}\nAssessed Risk Level: ${aiResult.risk_level}\nClinical Recommendations: ${aiResult.recommendations}${recText}\nTimestamp: ${new Date().toLocaleString()}\n\n------------------------------------------\nDisclaimer: Automated AI model prediction only. Consult a licensed physician for clinical diagnosis.`;
