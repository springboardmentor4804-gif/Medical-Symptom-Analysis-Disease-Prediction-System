...
def generate_pdf_report_bytes(patient, user_email: str, symptoms: list, ai_pred: dict, report_id: str) -> bytes:
    ...
    # Prominent Official Medical Disclaimer Box
    ...
    disclaimer_content = [
        Paragraph("<b>⚠️ OFFICIAL CLINICAL ADVISORY & MEDICAL DISCLAIMER</b>", disclaimer_title_style),
        Spacer(1, 3),
        Paragraph(
            "<b>IMPORTANT NOTICE:</b> This document contains automated disease risk evaluations generated by an Artificial Intelligence machine learning model based on reported symptoms. <b>This report is strictly a statistical prediction and DOES NOT constitute a medical diagnosis, certified lab outcome, or official physician's opinion.</b> AI predictions may contain inaccuracies and should never replace clinical judgment, physical examination, or diagnostic testing. <b>Always consult a licensed physician or qualified healthcare professional for accurate medical diagnosis and advice.</b> In the event of a medical emergency, contact your local emergency services immediately.",
    ...
    story.append(Paragraph(
        "<b>Important Notice:</b> This report is generated by MedAssist AI for informational and record-keeping purposes only. It is an automated statistical prediction and not a substitute for professional clinical judgment. Please consult a registered medical practitioner or licensed physician for comprehensive medical evaluation.",
        ParagraphStyle('Foot', parent=styles['Normal'], fontName='Helvetica-Bold', fontSize=7.5, leading=10, textColor=colors.HexColor('#475569'), alignment=1)
    ))
